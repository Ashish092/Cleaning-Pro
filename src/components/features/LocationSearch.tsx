...
const suburbs: Suburb[] = [
    ...
    { name: "Werribee", postcode: "3030", region: "Melbourne" },
    { name: "Werribee South", postcode: "3030", region: "Melbourne" },
    { name: "West Footscray", postcode: "3012", region: "Melbourne" },
...
export default function LocationSearch() {
  ...
  const filteredSuburbs = suburbs
    .filter(suburb => {
      ...
      return (
        ...
        `${suburb.name.toLowerCase()} ${suburb.postcode}`.includes(searchTerm)
      )
    })
  ...
  const handleSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedSuburb && !value.includes(selectedSuburb.postcode)) {
  ...
  return (
    <div className="max-w-2xl">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg
              focus:outline-none focus:ring-2 ring-[#0A61c9] focus:border-transparent"
          />
      ...
      <button
        className="mt-4 w-full bg-[#0A61c9] text-white py-3 rounded-lg font-medium
      ...
      {selectedSuburb && (
        <div className="mt-4 p-3 bg-[#e6f0fa] text-[#0A61c9] rounded-lg">
          <p className="text-sm">
